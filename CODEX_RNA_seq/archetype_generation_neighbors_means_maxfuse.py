...
indices_to_zero_out = indices_to_zero_out[indices_to_zero_out < adata_2_prot.obsp['spatial_neighbors_connectivities'].data.shape[0]]
...
# %%
print(indices_to_zero_out.max(), adata_2_prot.obsp['spatial_neighbors_connectivities'].data.shape[0])


# %%
print(len(adata_2_prot.obsp['spatial_neighbors_distances'].data), len(adata_2_prot.obsp['spatial_neighbors_connectivities'].data))
